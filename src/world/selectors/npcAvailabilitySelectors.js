...
function normalizePhaseRules(rules = {}) {
  ...
  return Object.fromEntries(
    Object.entries(rules)
      .filter(([phase]) => ALL_PHASES.has(phase))
      .map(([phase, value]) => {
...
export function evaluateNpcAvailability(meta = {}, timePhase, locationNodeId = null) {
...
export function getNpcAvailability(state, { npcNodeId = null, npcNode = null, locationNodeId = null } = {}) {
...
export function getNpcsForLocation(state, locationNodeId, { onlyAvailable = false } = {}) {
