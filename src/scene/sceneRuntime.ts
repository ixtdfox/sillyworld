...
import { setupSceneExplorationDebugShell } from '../render/debug/sceneExplorationDebugShell.ts';
import { attachGameplayIsometricCamera } from '../core/app/camera/gameplayCameraController.ts';
import type {
  CombatStateLike,
